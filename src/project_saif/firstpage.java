...
public class firstpage extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(display1, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(one)
    ...
    public void flag(){
        if(flag==1){
            display1.setText(display.getText());
            display.setText("");
            flag=0;
        }
        if(eq==1){
    ...
    public void calculate(){
        ...
        else
        {
            ...
            if(opt == "+")
            {
                display1.setText(String.format("%.0f", fnum) + opt + display.getText());
                result = fnum + snum;
                answer = String.format("%.0f", result);
                fnum=result;
                //display1.setText(display1.getText() + opt + display.getText());
    ...
    private void plusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plusActionPerformed
        ...
        calculate();
        //flag();
        //display1.setText(display.getText() + opt);
       //display1.setText(display1.getText() + opt + display.getText());
        opt = "+";
